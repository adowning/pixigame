...
class TopBack extends PIXI.Sprite {
  ...
  constructor() {
    ...
    const jackpot = this.contC.addChild(new PIXI.Text('$88779900', styletext))
...
class UserBlock extends PIXI.Sprite {
  ...
  constructor() {
    ...
    //
    const nameuser = this.cont.addChild(new PIXI.Text('USER NAME', styletext))
    nameuser.x = 190 - nameuser.width / 2
    nameuser.y = -15

    const moneyuser = this.cont.addChild(new PIXI.Text('99999.55', styletext2))
