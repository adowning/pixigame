    ...
    return (
      <div className="modal-window-message">
        <div className="modal-window-message__scale-cont">
          <div className="modal-window-message__text-unit modal-window-message__text">
            {this.state.text}
          </div>
          <div className="modal-window-message__text-unit modal-window-message__text-shadow">
            {this.state.text}
          </div>
          <img
            className="modal-window-message__ok game-button"
            onClick={this.onClose}
            src="/images/frenzy/ok_btn.png"
            alt=""
          />
          <img
            className="modal-window-message__close game-button"
            onClick={this.onClose}
