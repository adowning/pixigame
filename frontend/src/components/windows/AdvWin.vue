  ...
  <div className="modal-window-adv">
    <div className="modal-window-adv__scale-cont">
      <div className="modal-window-adv__logo">
        <img
          className="modal-window-adv__logo1"
          src="/images/frenzy/login/logo/logo0001.png"
          id="logo-adv"
          alt=""
        />
      </div>
      <div className="modal-window-adv__down">
        <img
          className="modal-window-adv__close game-button"
          @click="onClose"
          src="/images/frenzy/bonus_close.png"
          alt=""
        />
        <img
          className="modal-window-adv__btn game-button"
          @click="goRegister"
          id="btn-adv"
          src="/images/frenzy/reg_btn.png"
          alt=""
        />
