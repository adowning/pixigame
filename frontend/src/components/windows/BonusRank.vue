<template>
  <div className="modal-window-bonus">
    ...
    <div className="modal-window-bonus-rank" style="position: relative; z-index: 1">
      <img
      ...
      <div className="carousel__image">
        <img
          className="rank-bg"
          draggable="false"
          src="/images/frenzy/bonus/rank_bg.png"
          alt="Rank Background"
        />
        <div className="rank-wrapper">
          <div className="rank-control" v-for="user in rankList" :key="user.id">
            <img
              class="rank-bg"
              :src="`images/frenzy/bonus/${user.rank > 3 ? 'rank_4_20_bg' : 'rank_' + user.rank + '_bg'}.png`"
              alt=""
            />
            <div className="rank-content">
              <div className="rank-num">
                <template v-if="user.rank > 3">
                  <img src="/images/frenzy/bonus/rank_frame_4_20.png" alt="" />
                  <span>{{ user.rank }}</span>
                </template>
                <template v-else>
...
<script>
import { EE } from '../../Game'
import '@/assets/css/bonusrank.css'
