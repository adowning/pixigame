...
<script>
import { EE } from '../../Game'
import '@/assets/css/updatePopup.css'
...
export default {
  ...
  mounted() {
    ...
    const backImg = document.getElementsByClassName('modal-window-db_update-popup__back')[0]
  ...
  methods: {
    onResize(data) {
      const cont = document.getElementsByClassName('modal-window-db_update-popup__scale-cont')[0]
