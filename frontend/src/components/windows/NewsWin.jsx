...
export class NewsWin extends React.Component {
  ...
  componentDidMount() {
    ...
    ;(async () => {
      ...
      const cont = document.getElementsByClassName('modal-window-news__scale-cont')[0]
      if (cont) {
        setTimeout(() => {
    ...
    return (
      <div className="modal-window-news">
        <div className="modal-window-news__scale-cont">
          ...
          >
            <div className="news_carousel__image">
              <img src="/images/frenzy/news_img_1.png" alt="" className="carousel__item" />
              <img src="/images/frenzy/fb_button_click.png" alt="" className="fb_click_button" />
            </div>
            <div className="news_carousel__image">
              <img src="/images/frenzy/news_img_2.png" alt="" className="carousel__item" />
              <img src="/images/frenzy/fb_button.png" alt="" className="fb_button" />
            </div>
          </Slider>
        </div>
      </div>
