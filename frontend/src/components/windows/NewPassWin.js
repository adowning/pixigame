    ...
    return (
      <div className="modal-window-npass">
        <div className="modal-window-npass__scale-cont">
          <span className="modal-window-npass__info-text">
            {'A strong password should contain 6-16 characters.'}
          </span>
          <input
            className="modal-window-npass__pass1 modal-window-npass__fields"
            type="text"
            /*onFocus={this.onFocus}*/ onInput={this.onInput}
            placeholder={defaultText1}
          />
          <input
            className="modal-window-npass__pass2 modal-window-npass__fields"
            type="text"
            /*onFocus={this.onFocus}*/ onInput={this.onInput}
          ...
          <img
            className="modal-window-npass__close game-button"
            onClick={this.onClose}
            src="/images/frenzy/bonus_close.png"
            alt=""
          />
          <img
            className="modal-window-npass__ok game-button"
