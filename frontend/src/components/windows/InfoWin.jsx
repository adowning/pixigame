				...
				<div className="modal-window-info__scale-cont">
					{this.state.delete_sure?
						<div className="modal-window-info__popup-cont">
							...
							<img className="modal-window-info__popup-back" src="images/frenzy/message_back.png" alt=""/>
						</div>:""}
					<img className="modal-window-info__avatar" onClick={this.onSelectNewAvatar} src="pic.png" alt=""/>
					...
					<div className="modal-window-info__avatar_ok game-button" onClick={this.onAvatarComplete}  />
