      ...
      <div className="modal-window-info">
        <div className="modal-window-info__scale-cont">
          ...
          <img
            ...
            onClick={this.onSelectNewAvatar}
            src="pic.png"
            alt=""
          />
          <span className="modal-window-info__user modal-window-info__text">{'User'}</span>
          <span className="modal-window-info__pass modal-window-info__text">
            {'****************'}
          </span>
          ...
          <div
            className="modal-window-info__avatar_ok game-button"
            onClick={this.onAvatarComplete}
          />
          <img
            className="modal-window-info__done modal-window-info__btn game-button"
            onClick={this.props.goChangePass}
